...
const pedidoModel = {
   ...
   atualizarPedido: async (pId, pDescricao, pValor) => {
        const sql = 'UPDATE pedidos SET data_pedido=?, tipo_entrega=?, distancia_km=?, peso_kg=?, valor_base_km=?, valor_base_k WHERE id_produto=?; ';
