...
const pedidoModel = {
   ...
   atualizarPedido: async (pDataPedido, pTipoEntrega, pDistanciaKm, pPesoKg, pValorBaseKm, pValorBaseKg) => {
        const sql = 'UPDATE pedidos SET data_pedido=?, tipo_entrega=?, distancia_km=?, pPesoKg=?, valor_base_km=?, valor_base_kg=? WHERE id_produto = ?; ';
