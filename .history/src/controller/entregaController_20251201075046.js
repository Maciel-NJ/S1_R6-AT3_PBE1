...
/**
 * Calcula todos os valores relacionados ao custo de uma entrega,
 * aplicando regras comerciais como acréscimo, desconto e taxa extra.
 *
 * @param {Object} pedido - Objeto contendo os dados do pedido.
 * @param {*} pedido.distancia_km - Distância da entrega em quilômetros.
 * @param {*} pedido.valor_base_km - Valor cobrado por quilômetro.
 * @param {*} pedido.peso_kg - Peso da carga em quilogramas.
 * @param {*} pedido.valor_base_kg - Valor cobrado por quilograma.
 * @param {*} pedido.tipo_entrega - Tipo da entrega ("normal" ou "urgente").
 *
 ...
 */function calcularValoresEntrega(pedido) {
  ...
  return { valorDistancia, valorPeso, acrescimo, desconto, taxaExtra, valorFinal };
    ...
    /**
 * Controlador responsável por calcular o valor final de uma entrega
 * com base no ID do pedido enviado pelo cliente.
 *
 * @param {Object} req - Objeto da requisição HTTP.
 * @param {Object} req.body - Corpo da requisição.
 * @param {*} req.body.pedidoId - ID do pedido cuja entrega será calculada.
 *
 ...
 */ 
module.exports = { calcularEntrega: async (req, res) => {
    try {
