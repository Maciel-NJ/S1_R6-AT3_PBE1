...
adicionarCliente: async (req, res) => {
        ...
        try {
            ...
            if (!nomeCompleto || typeof nomeCompleto !== "string" || nomeCompleto.length < 3 || !cpf || typeof cpf !== "string" || cpf.length !== 11 || !telefone || typeof telefone !== "string" || telefone.length < 12 || !email || typeof email !== "string" ||
    !endereco || typeof endereco !== "string") {
