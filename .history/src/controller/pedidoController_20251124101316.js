    ...
    criarPedido: async (req, res) => {
        try {
            ...
            if (!id_cliente || !tipo_entrega === "urgente" || !tipo_entrega === "normal" || !valor_base_kg || !valor_base_km || !peso_kg || !distancia_km || !data_pedido) {
                return res.status(400).json({ message: 'Verifique os dados enviados e tente novamente, Tipos de entrega permitidos são 'urgente' });
            }
        ...
        function validarEntrega(tipo_entrega) {
            ...
            if (tipo_entrega === tiposPermitidos1 || tipo_entrega === tiposPermitidos2) {
