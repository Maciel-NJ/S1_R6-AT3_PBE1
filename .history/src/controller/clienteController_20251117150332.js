...
const clienteController = {
    ...
    adicionarCliente: async (req, res) => {
        ...
        try {
            const { nomeCompleto, cpf, telefone, email, endereço } = req.body;

            if (!nomeCompleto || typeof nomeCompleto !== "string" || nomeCompleto.length < 3 || !cpf || typeof cpf !== "string" || cpf.length !== 11 
                || !telefone || typeof telefone !== "string" || telefone.length < 12 || !email || typeof email !== "string" || !endereço || typeof endereço !== "string") {
