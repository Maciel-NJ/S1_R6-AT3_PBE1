...
adicionarCliente: async (req, res) => {
        ...
        try {
            ...
            if (!String(nomeCompleto) || nomeCompleto.length < 3 || cpf.length !== 11 || !String(telefone) || telefone.length < 15 || !String(email) || !String(endereco)) {
            ...
            const resultado = await clienteModel.criarCadastro(nomeCompleto, cpf);
